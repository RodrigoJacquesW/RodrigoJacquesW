...
My name is Rodrigo Jacques Wolff, I’m 25 years old and based in Brazil.  
I hold a degree in **Civil Engineering** from IFSC (Federal Institute of Santa Catarina) and worked for five years in the construction industry before transitioning into **Data Analytics**.

Currently, I work as a **Data Analyst** and, in my free time, I focus my studies on **Data Engineering**, especially on:
- Data extraction and ingestion  
- Automation and orchestration  
- Data pipelines (ETL / ELT)  
- Version control  
- Relational databases and cloud environments  

I enjoy building end-to-end data solutions and continuously improving data quality and scalability.
...
📌 **Pinned repositories below** showcase projects focused on:
- Data pipelines and automation  
- APIs and data extraction  
- Analytics and dashboards  
- End-to-end data workflows  

Each project includes clear documentation and real-world use cases.
